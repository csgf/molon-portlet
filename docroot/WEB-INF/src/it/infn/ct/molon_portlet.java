 ...
 * @author <a href="mailto:riccardo.bruno@ct.infn.it">Riccardo Bruno</a>(COMETA)
 */
public class molon_portlet extends GenericPortlet {

    // Instantiate the logger object
    AppLogger _log = new AppLogger(molon_portlet.class);
...
//            inputFileText = 
            ...
            path = "/tmp/molon2_executions_" + dateStr;
...
//            appInput.inputFileText = (String) request.getParameter("inputFile");
    ...
    void submitJobGroup(AppInput appInput) {
        ...
        taskToExecute.setInputFiles(inputFiles);
